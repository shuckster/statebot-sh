...
CC_FAILURE_LIMIT_BEFORE_REBOOT_DEFAULT="5"
...
CC_FAILURE_LIMIT_BEFORE_REBOOT=${CC_FAILURE_LIMIT_BEFORE_REBOOT:-${CC_FAILURE_LIMIT_BEFORE_REBOOT_DEFAULT}}
...
export CC_FAILURE_LIMIT_BEFORE_REBOOT
